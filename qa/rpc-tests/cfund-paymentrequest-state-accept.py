...
class CommunityFundPaymentRequestsTest(ElectrumTestFramework):
    ...
    def run_test(self):
        ...
        blocks = slow_gen(self.nodes[0], total_votes - yes_votes - 2)
        ...
        assert_equal(self.nodes[0].getpaymentrequest(paymentrequestid1)["status"], "pending")
        assert_equal(self.nodes[0].getpaymentrequest(paymentrequestid2)["state"], 0)
        assert_equal(self.nodes[0].getpaymentrequest(paymentrequestid2)["status"], "pending")
