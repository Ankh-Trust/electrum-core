...
class CFund005ProposalRejectedPreq(ElectrumTestFramework):
  ...
  def run_test(self):
      ...
      # Given
      proposalDetails = givenIHaveARejectedProposal(self.nodes[0], False, 5000, 60*60*24, "This is my proposal")
...
if __name__ == '__main__':
    CFund005ProposalRejectedPreq().main()