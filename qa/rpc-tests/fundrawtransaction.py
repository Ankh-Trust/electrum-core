...
class RawTransactionsTest(ElectrumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid electrum address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid electrum address" in e.error['message'])
