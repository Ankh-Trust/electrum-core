AC_DEFUN([ELECTRUM_FIND_BDB],[
  ...
  if test "x$BDB_CFLAGS" = "x"; then
    ...
    if test "x$bdbpath" = "xX"; then
      ...
      ELECTRUM_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
      ...
      ELECTRUM_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb53path}],db_cxx)
      bdbpath="${bdb53path}"
    fi
  else
  ...
  if test "x$BDB_LIBS" = "x"; then
    ...
    for searchlib in db_cxx-5.3 db_cxx db4_cxx; do
