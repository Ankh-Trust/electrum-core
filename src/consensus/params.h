...
static std::string sDeploymentsDesc[Consensus::MAX_VERSION_BITS_DEPLOYMENTS] = {
    ...
    "Ankh Fund",
    "Starts the accumulation of coins on the Ankh Fund",
    "Cold Staking",
    "Spread the accumulation of coins on the Ankh Fund to save on block space",
    "Increase the contributed amount to the Ankh Fund to 0.10AE per block",
    "NTP SYNC",
