...
public:
    ...
    CElectrumAddress(const CKeyID &id, const CKeyID &id2, const CKeyID &id3) { Set(id, id2, id3); }
    CElectrumAddress(const CScript &scriptIn) { Set(scriptIn); }
    ...
    bool GetVotingAddress(CElectrumAddress &address) const;
