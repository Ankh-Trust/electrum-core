...
#ifndef ELECTRUM_TEST_SCRIPTNUM10_H
#define ELECTRUM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Electrum Core 0.10.0, for cross-comparison.
 */
public:
