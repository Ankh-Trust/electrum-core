...
#define BOOST_TEST_MODULE Electrum Test Suite

#include <test_electrum.h>
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_electrum_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
