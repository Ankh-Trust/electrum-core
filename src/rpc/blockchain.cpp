...
UniValue getblockchaininfo(const UniValue& params, bool fHelp)
{
    ...
    BIP9SoftForkDescPushBack(bip9_softforks, "ankhfund", consensusParams, Consensus::DEPLOYMENT_COMMUNITYFUND);
...
{ //  category              name                      actor (function)         okSafeMode
  ...
  { "ankhfund",           "getproposal",            &getproposal,            true  },
  { "ankhfund",           "getpaymentrequest",      &getpaymentrequest,      true  },
