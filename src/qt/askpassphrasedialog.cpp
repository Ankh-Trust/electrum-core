    ...
    fCapsLock(false)
{
    ...
    switch(mode)
    {
        case Encrypt: // Ask passphrase x2
            ui->warningLabel->setText(tr("Enter the new passphrase for the wallet.<br/>Please use a passphrase of <b>ten or more random characters</b>, or <b>eight or more words</b> for better security."));
            ui->passLabel1->hide();
            ui->passEdit1->hide();
            setWindowTitle(tr("Encrypt wallet"));
        case EncryptTx: // Ask passphrase x2
            ui->warningLabel->setText(tr("Enter the new pin for the wallet.<br/>Please use a pin of <b>ten or more random characters</b>, or <b>eight or more words</b> for better security."));
            ui->passLabel1->hide();
            ui->passEdit1->hide();
    ...
    case Encrypt:
        {
            ...
            QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                    ...
                    "<br><br>" +
                    tr("Forgetting your passphrase and not having your mnemonic will make you <b>LOSE ACCESS TO ALL OF YOUR ELECTRA!!!</b>") +
                    "<br><br>" +
                    ...
                    if(model->setWalletEncrypted(true, newpass1))
                    {
                        QMessageBox::warning(this, tr("Wallet encrypted"),
                                ...
                                tr("%1 will close now to finish the encryption process. "
                                    ...
                                    "your Electra from being stolen by malware infecting your computer.").arg(tr(PACKAGE_NAME)) +
                                "</qt>");
                        QApplication::quit();
                    }
                    else
    ...
    case EncryptTx:
        {
            ...
            QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet txdata encryption"),
                    ...
                    "<br><br>" +
                    tr("Forgetting your pin and not having your mnemonic will make you <b>LOSE ACCESS TO ALL OF YOUR ELECTRA!!!</b>") +
                    "<br><br>" +
                    tr("Are you sure you wish to encrypt your wallet txdata?"),
                    QMessageBox::Yes|QMessageBox::Cancel,
                    QMessageBox::Cancel);
