    ...
    nCurrentFilter2(FILTER_ALL)
{
    ...
    proposalsBtn = new ElectrumPushButton(tr("Fund Proposals"));
    paymentRequestsBtn = new ElectrumPushButton(tr("Payment Requests"));
    consultationsBtn = new ElectrumPushButton(tr("Consultations"));
    deploymentsBtn = new ElectrumPushButton(tr("Deployments"));
    consensusBtn = new ElectrumPushButton(tr("Consensus Parameters"));
...
void DaoPage::onDetails() {
    if (!contextHash.isEmpty())
    {
        ...
        if (nCurrentView == VIEW_PROPOSALS)
            ...
            type = "consultation";
        QString link = "https://0ae.ankh-trust.com/dao/" + type + "/" + contextHash;
