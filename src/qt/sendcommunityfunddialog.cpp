    ...
    secDelay(secDelay)
{
    ...
    string warning = tr("By submitting the payment request a contribution of %1 0AE to the Community Fund will occur from your wallet.").arg(QString::fromStdString(fee)).toStdString();
