...
ElectrumAddressEntryValidator::ElectrumAddressEntryValidator(QObject *parent) :
    QValidator(parent)
{
}

QValidator::State ElectrumAddressEntryValidator::validate(QString &input, int &pos) const
{
    Q_UNUSED(pos);
...
ElectrumAddressCheckValidator::ElectrumAddressCheckValidator(QObject *parent) :
    QValidator(parent)
{
}

QValidator::State ElectrumAddressCheckValidator::validate(QString &input, int &pos) const
{
  Q_UNUSED(pos);
  ...
  else
  {
    ...
    CElectrumAddress addr(input.toStdString());
    if (addr.IsValid())
      return QValidator::Acceptable;
