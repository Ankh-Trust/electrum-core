...
private:
    ...
    QLabel* viewLbl;
    ElectrumPushButton* proposalsBtn;
    ElectrumPushButton* paymentRequestsBtn;
    ElectrumPushButton* consultationsBtn;
    ElectrumPushButton* deploymentsBtn;
    ElectrumPushButton* consensusBtn;
    QLabel* filterLbl;
