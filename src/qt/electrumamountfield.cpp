...
public:
    ...
    QSize minimumSizeHint() const
    {
        if(cachedMinimumSizeHint.isEmpty())
        {
            ...
            int w = fm.width(ElectrumUnits::format(ElectrumUnits::_AE, ElectrumUnits::maxMoney(), false, ElectrumUnits::separatorAlways));
...
bool ElectrumAmountField::validate()
{
    bool valid = false;
    value(&valid);
    setValid(valid);
...
void ElectrumAmountField::setValid(bool valid)
{
    if (valid)
...
bool ElectrumAmountField::eventFilter(QObject *object, QEvent *event)
{
...
QWidget *ElectrumAmountField::setupTabChain(QWidget *prev)
{
...
CAmount ElectrumAmountField::value(bool *valid_out) const
{
    return amount->value(valid_out);
}

void ElectrumAmountField::setValue(const CAmount& value)
{
