...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, ElectrumUnits::SeparatorStyle separators=ElectrumUnits::separatorStandard) const;
...
#endif // ELECTRUM_QT_TRANSACTIONTABLEMODEL_H
