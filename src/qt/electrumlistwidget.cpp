...
#include "electrumlistwidget.h"

ElectrumListWidget::ElectrumListWidget(QWidget *parent, QString title, ValidatorFunc validator) :
    QWidget(parent),
...
void ElectrumListWidget::onRemove()
{
    listWidget->takeItem(listWidget->row(listWidget->currentItem()));
}

void ElectrumListWidget::onSelect(QListWidgetItem* item)
{
    removeBtn->setVisible(item != nullptr);
}

void ElectrumListWidget::onInsert()
{
...
QStringList ElectrumListWidget::getEntries()
{
    QStringList ret;
