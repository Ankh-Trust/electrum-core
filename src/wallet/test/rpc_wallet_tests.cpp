...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CElectrumAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CElectrumAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CElectrumAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CElectrumAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CElectrumAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CElectrumAddress(arr[0].get_str()).Get() == demoAddress.Get());
