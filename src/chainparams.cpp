...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 21;
        ...
        consensus.nStakeMinAge = 60 * 60 * 2 / 720;	// minimum for coin age: 2 hours
        ...
        consensus.vParameters[Consensus::CONSENSUS_PARAM_FUND_SPREAD_ACCUMULATION].value = 100;
