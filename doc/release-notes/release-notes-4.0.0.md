...
### New 0AETech RPC Commands

A command to generate a private payment has been added. Electrum Core will take care of the negotiation with the 0AETech nodes and will create and broadcast the transaction. The syntax is:
...
### Management of 0AETech servers

0AETech servers added/removed with the RPC command addanonserver are now stored on the config file when specified by an extra parameter.
