# Electrum v4.3.0 Release Notes

## Introduces OpenAlias:

This PR https://github.com/electrum/electrum-core/pull/213 completes the implementation of the OpenAlias protocol into the Electrum Core client.
...
- Electrum enforces by default the use of DNSSEC
...
The secp256k1 lib from bitcoin 16.2 release was included into the codebase. While there are a number of improvements, the update was mainly needed due to the better build options for developers and allows newer OS's to build. This reduces the friction in getting setup and working with Electrum
...
- New RPC command `resolveopenalias` resolves an OpenAlias address to a Electrum address
