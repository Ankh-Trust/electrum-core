TOR SUPPORT IN ELECTRUM
======================

It is possible to run Electrum as a Tor hidden service, and connect to such services.

The following directions assume you have a Tor proxy running on port 9050. Many distributions default to having a SOCKS proxy listening on port 9050, but others may not. In particular, the Tor Browser Bundle defaults to listening on port 9150. See [Tor Project FAQ:TBBSocksPort](https://www.torproject.org/docs/faq.html.en#TBBSocksPort) for how to properly
configure Tor.


1. Run electrum behind a Tor proxy
---------------------------------

The first step is running Electrum behind a Tor proxy. This will already make all
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./electrum -proxy=127.0.0.1:9050


2. Run a electrum hidden server
------------------------------
...
your electrumd's P2P listen port (5556 by default).
	...
	-externalip=X   You can tell electrum about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/electrum-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./electrumd -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./electrumd ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./electrum -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
